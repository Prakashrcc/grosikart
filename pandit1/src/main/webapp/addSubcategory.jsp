...
<meta name="viewport" content="width=device-width, initial-scale=1">
 <meta charset="utf-8">
    ...
    <title>GroSwift -Add SubCategory!</title>
<style>
body {
...
<!-- Modal for successfull adding product -->
 ...
 <%@ page isELIgnored="false" %>
			...
			<% HttpSession registerSession=request.getSession();
				try{
					String registerValue=registerSession.getAttribute("addSubcategory").toString();
					if(registerValue.equals("1")){
						registerSession.setAttribute("addSubcategory", "0");
...
<div id="mySidenav" class="sidenav">
  ...
  <a href="#" class="active">Add SubCategory</a>
...
<div id="main">
   ...
   ">
				 <h2 class="h2" style=" ">GroSwift Admin Panel</h2>
			</div>
	...
	<div class="container container2" style="width: 90%;">
		...
		<form action="addSubcategory" style="width: 100%; " method="post">
			<div class="row">
				<div class="col-12">
				 <h4 style="    width: fit-content;
    border-bottom: 1px solid black;">Add a new SubCategory</h4>
				</div>
			</div>
			...
			<div class="row" style="margin-top: 2%;">
				...
				<div class="col-12">
            		...
            		String pass="uchiha7686";
            			...
            			String query="select * from grosikart_category order by category_name";
  					  ...
  					  <option value="<%=subcategory.getString(1) %>"><%=subcategory.getString(2) %></option>
			...
			<div class="row" style="margin-top: 2%;">
				...
				<div class="col-12">
					 <input type="text" name="subCategory" class="select" placeholder="Enter Sub Category Name" required>
				</div>
			</div>
			...
			<div class="row" style="margin-top: 2%;">
				<div class="col-12">
				 <h6>SubCategory Image URL *</h6>
				</div>
				<div class="col-12">
					 <input type="text" class="select" name="subCategory_image" placeholder="Enter SubCategory Image Link" required>
				</div>
			</div>
			
			<div class="row" style="margin-top: 2%;">
				<div class="col-12">
				<button type="submit" class="btn1"> Add SubCategory</button>
				</div>
