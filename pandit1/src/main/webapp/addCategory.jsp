...
<!-- Modal for successfull adding product -->
 ...
 <%@ page isELIgnored="false" %>
			...
			<% HttpSession registerSession=request.getSession();
				try{
					String registerValue=registerSession.getAttribute("addCategory").toString();
					if(registerValue.equals("1")){
						registerSession.setAttribute("addCategory", "0");
						out.println(" <script src='https://cdnjs.cloudflare.com/ajax/libs/limonte-sweetalert2/6.11.4/sweetalert2.all.js'></script>");
						out.println("<script src='https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js'></script>");
						out.println("<script src='https://unpkg.com/sweetalert/dist/sweetalert.min.js'></script>");
						out.println("<script>");
						out.println("$(document).ready(function(){");
						out.println("swal ( 'Adding Category Successfull !' ,  '' ,  'success' );");
						out.println("});");
						out.println("</script>");
					}
						...
						out.println("<script>");
						out.println("$(document).ready(function(){");
						out.println("swal ( 'Adding Category Failed !' ,  'Category name already exists!' ,  'error' );");
						out.println("});");
						out.println("</script>");
					}
...
<div id="main">
   ...
   ">
				 <h2 style="  " class="h2">GroSwift Admin Panel</h2>
			</div>
	...
	<div class="container container2" style="width: 90%;">
		...
		<form action="addCategory" style="width: 100%; " method="post">
			<div class="row">
				<div class="col-12">
				 <h4 style="    width: fit-content;
    border-bottom: 1px solid black;">Add a new Category</h4>
				</div>
			</div>
			...
			<div class="row" style="padding-top: 4%;">
				...
				<div class="col-12">
					<input type="text" name="category" class="select" placeholder="Enter Category Name" required>
				</div>
			</div>
